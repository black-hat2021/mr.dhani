...
linkwa="https://wa.me/6288239375740"
hp="1"
hp1="1"
...
{i}----------------------------------------------------------------
{k}- {p}Pulsa : 088239375740
{k}- {p}Dana  : 088239375740
{k}- {p}Gopay : 088239375740
{k}- {p}No Wa : 6288239375740
{i}----------------------------------------------------------------
...
CTRL + Z Exit""")
	...
	if gr == "":
		...
		time.sleep(1)
		bash("xdg-open https://wa.me/6288239375740?text=Hallo+Bang")
		detik(00, 50)
		list1()
	elif gr == "GRUB":
		time.sleep(1)
...
{k}({i}3{k}){p} Join Grub WhatSapp PROJECT DHANI TEAM
{k}({i}4{k}){p} Rreport
{k}({i}5{k}){p} Intall Bahan (Wajib)
{k}({i}6{k}){p} Quit""")
	wel=input(f"{c}({i}?{c}){p} Mr.Dhanz {c}")
	if wel == "":
		...
		kata(f"{p}Anda Akan Lanjut KeGrub Whatsapp PROJECT DHANI TEAM")
...
Jika Sudah Terkirim Lihat Saja DiSms (Pesan)""")
		...
		detik(00, 45)
		bash("xdg-open https://wa.me/6288239375740?text=Bang+Minta+Username+Sama+Password+*AllTools*+Saya+Mohon+Pelis+Mr.Dhanz+Ganteng+")
		time.sleep(5)
		detik(00, 45)
		bash("xdg-open https://wa.me/6288239375740?text=Bang+Minta+Username+Sama+Password+*AllTools*+Saya+Mohon+Pelis+Mr.Dhanz+Ganteng+")
		time.sleep(5)
...
{c}[{m}!{c}]{q}{m3} Hub Adm!n :https://wa.me/6288239375740{q}
{c}[{m}!{c}]{q}{m3} Mr.Dhanz{q}""")
	bash("xdg-open https://wa.me/6288239375740?text=Bang+Kapan+Selesai+Perbaiki+???+")
def tik11():
    text = ["⟩   ","⟩⟩  ","⟩⟩⟩ ","⟩⟩   ","⟩   ","     ","Done !!"]
    for o in text:
            waktu(1)
...
{c}Whatsapp : {m3}+6288239375740{q}
{c}Email    : {m3}ahmdramdhani44@gmail.com{q}
{c}Via Pulsa: {m3}088239375740{q}
{c}Dana     : {b3}088239375740{q}
{c}Link Aja : {b3}—{q}
{c}Shopey   : {b3}088239375740{q}
...
{p}[{k}8{p}]{p}———{k}⟩{i}⟩{c}SegeraHadir 		{i}⟨{k}⟨{p}———{k}⟩{i}⟩{c} Mr.Dhanz
{p}[{k}9{p}]{p}———{k}⟩{i}⟩{c}SegeraHadir 		{i}⟨{k}⟨{p}———{k}⟩{i}⟩{c} Mr.Dhanz
...
{p}▒█▄▄▄█ █▀▀▀ ▀░░▀ ▀░░░▀ {i}▒█▄▀▄█ ▒█░▒█{c}@Dumai-991
{p}[{i}+{p}]{c}––––––––––––––––––––––––––––––––––––––––––––––{p}[{i}+{p}]
{p}[{i}+{p}]{c}Athour        : Mr.Dhanz			 {p}[{i}+{p}]{c}
{p}[{i}+{p}]{c}Whatsapp      : 6288239375740		 {p}[{i}+{p}]{c}
{p}[{i}+{p}]{c}Facebook      : Dhanz			 {p}[{i}+{p}]{c}
{p}[{i}+{p}]{c}Grup WhatSapp : PROJECT DHANI TEAM		 {p}[{i}+{p}]{c}
{p}[{i}+{p}]{c}––––––––––––––––––––––––––––––––––––––––––––––{p}[{i}+{p}]""")
	kata3(f"""
{p}[{i}-{i}+{p}]{c}»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»«»{p}[{i}+{i}-{p}]
...
#		main3()
		...
		if axis2 =="":
			...
			os.system("xdg-open https://wa.me/6288239375740?text=Bang+Username+Sama+Passwordnya+Apa+Bang...+Bilang+Oranv+Ini+Usernamenya+*Dumai*+Passwordnya+*Riau*+??+")
			bash("sleep 2")
...
Script Yang Rusak Sudah DiUpdate Sama #Mr.Dhanz
Jika Ada Masalah Terhadap Script Silahkan Report KeAdmin
{q}
@{m3}https://wa.me/6288239375740
@{m3}Mr.Dhanz
...
def Wa():
       os.system("xdg-open https://api.whatsapp.com/send/?phone=%2B6288239375740&text&app_absent=0")
...
{c}[{m}!{c}]{b3}AXIS [088239375740] VIA PULSA AJA BANG...{q}
...
{k3}╚═╝░░╚═╝╚══════╝╚══════╝{b3}░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝╚═════╝░{q}
{c}[{k}•{c}]{m3}============================================================{q}{c}[{k}•{c}]{q}
[{k}•{c}]{h}Script By         : {c}Mr.Dhanz
[{k}•{c}]{h}Github            : {c}github.com/Dumai-991
[{k}•{c}]{h}WhatSapp          : {c}088239375740
...
{b3}[ 56 ]~Script Termux By Mr.Dhanz	[  19.20  ]{q}
...
{b3}Donasi : Via Pulsa [{q} {m3}088239375740{q} {b3}]  Axis{q}
...
{m3}[••]56 ≈≈ Termux Logo By Mr.Dhanz{q}    {m3}[••]{q}
...
""")
	...
	os.system("sleep 2")
	kon=input(f"{c}[•]{m}==={c}[•]{m}Mr.Dhanz{k}>>> {m}")
	if kon == "":
...
""")
		...
		os.system("xdg-open https://api.whatsapp.com/send/?phone=6288239375740&text&app_absent=0")
